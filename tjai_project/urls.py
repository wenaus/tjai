...
urlpatterns = [
    ...
    path("api/entry/<str:entry_id>/archive", views.api_archive_entry, name="api_archive_entry"),
    path("api/entry/<str:entry_id>/restore", views.api_restore_entry, name="api_restore_entry"),
    ...
    path("captures/", views.captures_page, name="captures"),
    path("capture/<uuid:entry_id>/<str:filename>", views.capture_file, name="capture_file"),
    ...
    path("research-sw.js", views.research_service_worker, name="research_service_worker"),
    path("offline-sw.js", views.offline_service_worker, name="offline_service_worker"),
    path("research-list/", views.research_list_page, name="research_list"),
    path("research-obsolete/", views.research_obsolete_page, name="research_obsolete"),
    path("research-detail/<path:detail_entry_id>/", views.research_detail_page, name="research_detail_by_entry_id"),
    path("research-detail/", views.research_detail_page, name="research_detail"),
    path("api/research/list", views.api_research_list, name="api_research_list"),
    path("api/research/detail", views.api_research_detail, name="api_research_detail"),
    ...
    path("inflight/", views.inflight_page, name="inflight_index"),
    path("inflight/<path:entry_id>/", views.inflight_page, name="inflight_view"),
    path("api/inflight/list", views.api_inflight_list, name="api_inflight_list"),
    path("api/inflight/<str:entry_id>/state", views.api_inflight_state, name="api_inflight_state"),
    path("api/inflight/<str:entry_id>/item", views.api_inflight_item, name="api_inflight_item"),
