...
- `tj hey` — Personal dashboard of context, todos, and other evolving information
...
- `tj l p/b/d/ai` — Profiles / bookmarks / todos / AI guidelines
...
- `tj q [b|r|d|p]` — By type: bookmark, remembered, do, profile
